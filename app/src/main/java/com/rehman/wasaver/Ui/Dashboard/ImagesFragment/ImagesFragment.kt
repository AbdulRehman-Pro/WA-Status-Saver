package com.rehman.wasaver.Ui.Dashboard.ImagesFragment
...
class ImagesFragment : Fragment() {
    ...
    private fun initViews() {
        ...
        val textPaint = binding.titleImg.paint
        val width = textPaint.measureText("    Images")
        val textShader = LinearGradient(
            0f, 0f, width, binding.titleImg.textSize, intArrayOf(
                Color.parseColor("#3bc1e6"), Color.parseColor("#ce38ce")
            ), null, Shader.TileMode.CLAMP
        )
        binding.titleImg.paint.shader = textShader
